...
vim.keymap.set('n', '<leader>ff', '<cmd>Telescope find_files<cr>',
    { noremap = true, silent = true, desc = "Open telescope to find files by name" })
vim.keymap.set('n', '<leader>fg', '<cmd>Telescope live_grep<cr>',
    { noremap = true, silent = true, desc = "Open telescope to find files by grep" })
...
vim.keymap.set('n', '<leader>e', vim.diagnostic.open_float,
    { noremap = true, desc = "Open the error floating window from the LSP" })
...
vim.keymap.set('n', 'gsd', '<cmd>vsplit | lua vim.lsp.buf.definition()<CR>',
    { noremap = true, desc = 'Go to definition in vertical split' })
...
vim.keymap.set({ 'n', 'v' }, '<leader>q', ':<C-u>\'<,\'>AmazonQ<CR>',
    { noremap = true, desc = "Run AmazonQ command on selection or current line" })
